(function () {
  ...
  <p class="payment-card__ref">Liquidación: ${group.every(x=>x.liquidations?.approved_at&&x.liquidations?.frozen_at)?'aprobada · no requiere otra aprobación del lote':'pendiente de aprobación'} · Pago: ${esc(p.estado)}</p>
