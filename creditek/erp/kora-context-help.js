(function () {
  ...
  const HELP_LIBRARY = Object.freeze({
    ...
    'aliados-presupuesto.html': guide('Presupuesto de Aliados', 'Permite cargar y analizar las metas mensuales de cada plataforma de crédito.', ['Selecciona el mes.', 'Compara la meta con los créditos vendidos.', 'Gerencia puede cargar o actualizar las condiciones oficiales.'], ['El incentivo potencial no es utilidad contabilizada.', 'Registra siempre la fuente de la meta.']),
    ...
    'creditos-cartera.html': guide('Créditos y cartera', 'Separa la autorización de Nova, el pago al aliado y las cuotas posteriores del cliente.', ['Consulta el estado real del crédito.', 'Registra únicamente pagos ya validados.', 'Documenta las gestiones de Cartera o Cobra.', 'Usa el desempeño observado para revisar futuras reglas de Nova.'], ['Los créditos pre-Nova no se bloquean retroactivamente.', 'Una diferencia administrativa no cambia por sí sola el comportamiento de pago del cliente.']),
