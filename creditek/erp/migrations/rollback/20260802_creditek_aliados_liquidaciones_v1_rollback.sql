...
drop function if exists public.aliados_guardar_pagamos(uuid,numeric);
drop function if exists public.aliados_reportar_novedad(uuid,uuid,text);
drop function if exists public.aliados_resolver_novedad(uuid,text);
drop function if exists public.aliados_resolver_operaciones_propias(uuid);
...
drop function if exists public.aliados_impedir_cambio_operacion_aprobada();
