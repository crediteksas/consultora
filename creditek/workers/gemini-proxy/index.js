...
var index_default = {
  async fetch(request, env) {
    ...
    if (path !== "/generate" && path !== "/openai/responses" && path !== "/recraft/images" && path !== "/anthropic/messages" && path !== "/veo/generate" && path !== "/veo/status") return err("Ruta no encontrada", 404);
