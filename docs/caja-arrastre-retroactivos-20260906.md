...
Al instalar la migración se detuvo la publicación del frontend porque el pipeline también incluía el directorio «Clientes y cuentas» del commit `58ae9b9`. Oscar autorizó después publicar ambos juntos sin revisión de Claude. La publicación se realiza por el pipeline oficial y se comprueba su manifiesto y los archivos servidos.
