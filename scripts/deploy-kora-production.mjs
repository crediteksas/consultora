...
const run = (command, args, options = {}) => execFileSync(command, args, { cwd: root, env, encoding: 'utf8', stdio: options.capture ? 'pipe' : 'inherit' });
...
// El manifiesto generado se publica como kora-build-manifest.json.
