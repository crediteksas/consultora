...
test('el shell KORA se activa en las pantallas principales autenticadas', async () => {
  ...
  assert.match(tablero, /sidebar\.js\?v=2\.0\.31" data-kora-shell="1\.0\.0"/);
  assert.match(utilidad, /sidebar\.js\?v=2\.0\.31" data-kora-shell="1\.0\.0"/);
  assert.match(catalogo, /sidebar\.js\?v=2\.0\.31" data-kora-shell="1\.0\.0"/);
});
