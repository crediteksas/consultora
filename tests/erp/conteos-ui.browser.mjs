...
try {
 ...
 await page.evaluate(async()=>{
   ...
   const c={id:'11111111-1111-4111-8111-111111111111',tienda_codigo:'A',tienda_nombre:'Tienda de prueba',corte_at:new Date(Date.now()-60000).toISOString(),creado_nombre:'Operadora',estado:'abierto'};
 ...
 const book=XLSX.utils.book_new();XLSX.utils.book_append_sheet(book,XLSX.utils.aoa_to_sheet([['Formato','KORA-CONTEO-1'],['ID',id]]),'Resumen');
 XLSX.utils.book_append_sheet(book,XLSX.utils.json_to_sheet([{'Código producto':'VID','IMEI / serial':'','Cantidad física':499},{'Código producto':'CEL','IMEI / serial':'000000000000001','Cantidad física':1}]),'Conteo');
 ...
 await page.locator('#conteos-fecha-modo').selectOption('corte');
