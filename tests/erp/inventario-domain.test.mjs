...
test('tienda ve remisión; nunca sustituye un faltante por costo del proveedor', () => {
  assert.equal(domain.valorVisibleUnidad({ precio_tienda: 120000, costo_remision: 90000 }), 120000);
  assert.equal(domain.valorVisibleUnidad({ precio_tienda: null, costo_remision: 90000 }), null);
  assert.equal(domain.valorVisibleStock({ precio_tienda: 15000, costo_promedio: 12000 }), 15000);
});
...
test('consultas de tienda no solicitan columnas internas', () => {
