-- Read-only snapshot from the authorized KORA checkout c802c4fe for integration tests.

-- 20260906191354_caja_arrastre_movimientos_retroactivos.sql
...
-- 20260920181612_caja_corte_arqueo_apertura.sql
begin;
...
-- 20260921231517_caja_cierre_manual_y_corte_automatico.sql
begin;
