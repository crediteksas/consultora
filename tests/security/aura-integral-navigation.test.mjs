...
const officialModules = [
  ...
  ['agent-1', 'Piezas comerciales', '/creditek/agentes/creditek-agente-redes.html'],
  ['agent-3', 'Publicación y métricas', '/creditek/agentes/agente3-meta-ads.html'],
...
test('los encabezados internos conservan los nombres funcionales aprobados', async () => {
  ...
  assert.match(agent1, /Piezas comerciales/);
  assert.doesNotMatch(agent1, /Agente 1/);
